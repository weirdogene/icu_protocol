...
(function () {
    ...
    var isSaveable = /^(airway-s\d+|airway-toc|vap-s\d+|vap-toc|sup-s\d+|sup-toc|ecmo-s\d+|ecmo-toc|nutr-s\d+|nutr-toc|wean-s\d+|wean-toc|ckrt-s\d+|ckrt-toc|abx-s\d+|abx-toc|bcid-guide|calc-)/.test(page);
