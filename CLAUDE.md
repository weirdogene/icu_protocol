...
- `{prefix}-toc.html` — 프로토콜 목차 (airway-toc, vap-toc, ecmo-toc, nutr-toc, sup-toc, wean-toc, ckrt-toc)
...
| Continuous Kidney Replacement Therapy | ckrt | 7 | 완료 |
| ICU Antibiotics Guide | abx | 5 (s1-s5) | 진행 중 |
| Antibiotic guide based on BCID2 | bcid-guide | — (단일 대화형 페이지) | 테스트 버전 |
